...
set CLASSPATH=%APP_HOME%\lib\sandbox.jar;%APP_HOME%\lib\junit-4.13.2.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar


@rem Execute sandbox
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SANDBOX_OPTS%  -classpath "%CLASSPATH%" sandbox.GameWrapper %*
