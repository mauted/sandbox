...
public enum ColorMap {
    ...
    FLOWER(new Color[] {
        new Color(102, 141, 60),
        new Color(213, 117, 0),
        new Color(210, 202, 105),
    }),
    CHICKEN(new Color[] {
        new Color(207, 92, 92),
        new Color(98, 138, 170),
        new Color(182, 229, 253),
        new Color(255, 255, 255),
    }),
    PARTICLE_SPARK(new Color[] {
        new Color(255, 220, 80),
        new Color(255, 255, 220),
    }),
    PARTICLE_LEAF(new Color[] {
        new Color(66, 109, 124),
        new Color(115, 168, 142),
    }),
    EGG(new Color[] {
        new Color(210, 202, 180),
